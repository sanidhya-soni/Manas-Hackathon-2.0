                ...
                script {
                    ...
                    withEnv(["PATH+SCANNER=${scannerHome}\\bin"]) {
                        bat 'sonar-scanner.bat \
                             ...
                             -Dsonar.sources=. \
                             -Dsonar.host.url=http://192.168.64.1:9000 \
...
//                 bat 'timeout /t 10 /nobreak'
                bat "curl -X POST -H \"Content-Type: application/json\" \
                    -d '{\"name\":\"db\",\"type\":\"prometheus\",\"url\":\"http://192.168.64.1:9090\",\"access\":\"proxy\",\"isDefault\":true}' \
                    http://admin:${API_KEY}@192.168.64.1:3000/api/datasources"
                bat "curl -X POST -H \"Content-Type: application/json\" \
